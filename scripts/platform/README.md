...
For continuous operation, prefer **Settings → Autonomous schedules** in the UI or create an `AutonomousSchedule` via API — the worker process runs them automatically.
