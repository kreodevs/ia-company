export const settings = {
  ...
  tabs: {
    ...
    mcp: "Servidores MCP",
    delivery: "Entrega cliente",
  },
  delivery: {
    title: "Marca en entregas públicas",
    subtitle: "Logo, colores y avisos legales en los enlaces /d/:token que compartes con clientes.",
    loading: "Cargando marca…",
    loadError: "No se pudo cargar la configuración de entrega.",
    saved: "Guardado.",
    logoUrl: "URL del logo",
    primaryColor: "Color principal",
    contactEmail: "Email de contacto (visible al cliente)",
    footerText: "Texto del pie de página",
    confidentialityNotice: "Aviso de confidencialidad",
    confidentialityPlaceholder: "Este documento es confidencial y solo para el destinatario…",
  },
  interests: {
  ...
  mcp: {
    ...
    validateLlm: "Validar con LLM",
    validateOk: "Compatible con {{provider}}/{{model}} — {{count}} herramientas",
