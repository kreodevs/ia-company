...
4. When finished: **Informe final** + per-agent documents in preview.
5. **Notifications** link to the human encargo view.
6. **War room** stays available for live tactical view.
