...
const statusPillVariants = cva(
    "inline-flex items-center gap-[var(--spacing-xs)] rounded-full px-[var(--spacing-sm)] py-[var(--spacing-xxs)] text-xs font-semibold border transition-all duration-[var(--transition-base)]",
    {
        variants: {
            status: {
            ...
            size: {
                ...
                md: "px-[var(--spacing-sm)] py-[var(--spacing-xxs)] text-xs",
