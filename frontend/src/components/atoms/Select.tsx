...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn("px-[var(--spacing-sm)] py-1.5 text-sm font-semibold", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref} className={cn("-mx-1 my-[var(--spacing-xs)] h-px bg-muted", className)} {...props} />
));
