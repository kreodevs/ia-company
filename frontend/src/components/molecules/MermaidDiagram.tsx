...
export interface MermaidDiagramProps {
  code: string
  /** Repara heurísticamente antes de render. Default: true */
  autoRepair?: boolean
  /** Estilo compacto para embed en prose markdown */
  compact?: boolean
  className?: string
  emptyMessage?: string
  /** Botón expandir en embed (docs markdown). Default: true */
    ...
    return (
      ...
      >
        <div className="flex items-start gap-[var(--spacing-sm)] text-sm text-[var(--destructive)]">
          <AlertCircle className="mt-[var(--spacing-xxs)] h-4 w-4 shrink-0" />
