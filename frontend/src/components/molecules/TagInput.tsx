            ...
            <div className="flex flex-col gap-[var(--spacing-xs)] w-full">
                ...
                >
                    {value.map((tag, index) => (
                        <span
                            key={`${tag}-${index}`}
                            className="inline-flex items-center gap-[var(--spacing-xs)] px-[var(--spacing-sm)] py-[var(--spacing-xs)] text-xs font-semibold rounded-full bg-[var(--primary)] text-[var(--primary-foreground)] shadow-sm"
                        >
                            {tag}
                            <button
                                type="button"
