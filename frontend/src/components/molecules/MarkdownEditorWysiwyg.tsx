  ...
  const plugins: RealmPlugin[] = [
    ...
    imagePlugin(
      options.onImageUpload
        ? {
            imageUploadHandler: (file) => options.onImageUpload!(file),
          }
        : undefined,
    ),
    tablePlugin(),
...
export const MarkdownEditorWysiwyg = forwardRef<
  MarkdownEditorWysiwygRef,
    ...
    return (
      ...
      >
        <MDXEditor
          ...
          plugins={plugins}
          spellCheck
          className={cn("kreo-mdx-editor dark-theme", readOnly && "kreo-mdx-editor--readonly")}
