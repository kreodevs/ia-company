# API de tiempo de ejecución de trabajadores de Cloudflare

API clave en tiempo de ejecución para el desarrollo de Workers.

## Obtener API```typescript
// Subrequest
...
- Estándares web: https://developers.cloudflare.com/workers/runtime-apis/web-standards/
- Enlaces: https://developers.cloudflare.com/workers/runtime-apis/bindings/